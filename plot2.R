...
plot2 <- function() {
        plot(d$timestamp,d$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
        dev.copy(png, file="plot2.png", width=480, height=480)
        dev.off()
        
}
plot2() ##calling the function saves plot2.png in the working directory